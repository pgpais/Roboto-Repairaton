...
public class GlobalManager : SingletonBehaviour<GlobalManager>
{
    ...
    public void ProcessFade(bool fadeIn, int sortOrder)
    {
        ...
        AudioSource fadeSFX = fadeCanvas.GetComponent<AudioSource>();
        if (fadeIn)
        {
    ...
    /// </summary>
    public void ChangeScene(int targetScene, int fadeSortOrder)
    {
    ...
    /// </summary>
    private IEnumerator ChangeSceneIE(int targetScene, int fadeSortOrder)
    {
